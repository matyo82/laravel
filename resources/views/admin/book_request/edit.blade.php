                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mx-auto">
                                        <form method="post" action="{{ route('book-request.update', $book_request) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <input id="t-text" type="text" name="title"
                                                    placeholder="عنوان کتاب خود را وارد کنید . . . " class="form-control"
                                                    value="{{ old('title', $book_request->title) }}" required>
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                <input id="t-text" type="text" name="writer"
                                                    ...
                                                    value="{{ old('writer', $book_request->writer) }}" required>
                                                @error('name')
                                                    <span class="alert_required bg-danger text-white p-1 rounded"
                                                        role="alert">
                                                        <strong>
                                            ...
                                            <div class="form-group">
                                                <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                    placeholder="لطفا توضیحات خود را وارد کنید . . ." required>{{ old('description', $book_request->description) }}</textarea>
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class="mt-4 btn btn-warning" value="ویرایش">
                                            </div>
