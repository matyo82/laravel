...
@section('head-tag')
    <title>product-details-tab1</title>
@endsection
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product-details-img">
                            <div class="zoompro-border zoompro-span">
                                <img class="zoompro" src="{{asset('front-assets/images/product-details/product-detalis-l1.jpg')}}" data-zoom-image="{{asset('front-assets/images/product-details/product-detalis-bl1.jpg')}}" alt="" /> <span>-29%</span>
                            </div>
                            <div id="gallery" class="mt-20 product-dec-slider">
                                <a data-image="{{asset('front-assets/images/product-details/product-detalis-l1.jpg')}}" data-zoom-image="assets/images/product-details/product-detalis-bl1.jpg">
                                    <img src="{{asset('front-assets/images/product-details/product-detalis-s1.jpg')}}" alt="">
                                </a>
                                <a data-image="{{asset('front-assets/images/product-details/product-detalis-l2.jpg')}}" data-zoom-image="{{asset('front-assets/images/product-details/product-detalis-bl2.jpg')}}">
                                    <img src="{{asset('front-assets/images/product-details/product-detalis-s2.jpg')}}" alt="">
                                </a>
                                <a data-image="{{asset('front-assets/images/product-details/product-detalis-l3.jpg')}}" data-zoom-image="{{asset('front-assets/images/product-details/product-detalis-bl3.jpg')}}">
                                    <img src="{{asset('front-assets/images/product-details/product-detalis-s3.jpg')}}" alt="">
                                </a>
                                <a data-image="{{asset('front-assets/images/product-details/product-detalis-l4.jpg')}}" data-zoom-image="{{asset('front-assets/images/product-details/product-detalis-bl4.jpg')}}">
                                    <img src="{{asset('front-assets/images/product-details/product-detalis-s4.jpg')}}" alt="">
                                </a>
                                <a data-image="{{asset('front-assets/images/product-details/product-detalis-l5.jpg')}}" data-zoom-image="{{asset('front-assets/images/product-details/product-detalis-bl5.jpg')}}">
                                    <img src="{{asset('front-assets/images/product-details/product-detalis-s5.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="product-area pb-85">
            <div class="container">
                ...
                <div class="product-slider-active owl-carousel">
                    ...
                    <div class="product-wrap">
                        <div class="product-img mb-15">
                            <a href="product-details.html"><img src="{{asset('front-assets/assets/images/product/pro-hm1-6.jpg')}}" alt="product"></a>
